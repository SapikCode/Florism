...
<body>
    ...
    <div onclick="ketambah()" class="body">
        <a class="card wallet" href="#">
             <div class="overlay"></div>
          <div class="circle">
            <img src="css/assetcss/camping.png">
        ...
        <div onclick="kedata()" class="body">
            <a class="card wallet" href="#">
                 <div class="overlay"></div>
              <div  class="circle">
                <img src="css/assetcss/travel.png">
...
<script>
    function ketambah(){
        window.location.href=("tambahgaleri.php");
    }

    function kedata(){
        window.location.href=("datawisata.php")
    }
